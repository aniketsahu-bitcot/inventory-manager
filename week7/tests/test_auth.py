...
from week7.tests.conftest import client
...
def test_login_success_admin()-> None:
...
def test_login_sets_cookies()-> None:
...
def test_login_username_case_sensitive()-> None:
...
def test_login_with_extra_fields()-> None:
...
def test_login_with_whitespace_username()-> None:
...
def test_login_min_length_username()-> None:
...
def test_login_max_length_username()-> None:
...
def test_login_empty_body()-> None:
    """Empty JSON body → 422"""
...
def test_login_wrong_data_types()-> None:
...
def test_logout_when_logged_in()-> None:
...
def test_logout_only_access_token_present()-> None:
...
def test_logout_only_refresh_token_present()-> None:
...
def test_logout_with_invalid_cookie_values()-> None:
...
def test_logout_wrong_http_method()-> None:
...
def test_refresh_token_success() -> None:
    ...
    refresh_token = login_and_get_refresh_token("admin_user", "password123")
...
def test_refresh_token_multiple_times() -> None:
...
def test_refresh_token_only_refresh_cookie_present() -> None:
...
def test_refresh_token_after_logout() -> None:
...
def test_refresh_token_empty_cookie_value() -> None:
...
def test_refresh_token_with_minimal_cookie_value() -> None:
...
def test_refresh_token_large_cookie_value() -> None:
...
def test_refresh_token_missing_cookie() -> None:
...
def test_refresh_token_invalid_cookie() -> None:
...
def test_refresh_token_tampered_payload() -> None:
...
def test_refresh_token_only_access_token_present() -> None:
...
def test_refresh_token_wrong_http_method() -> None:
...
def test_register_user_happy_path(client, db: Session, roles)-> None:
...
def test_register_username_edge_case_max_length(client)-> None:
...
def test_register_email_edge_case_long_email(client)-> None:
...
def test_register_password_boundary_min_length(client)-> None:
...
def test_register_password_boundary_max_length(client)-> None:
...
def test_register_missing_required_fields(client)-> None:
    """Register user with missing required fields should fail."""
    response = client.post("/auth/register", json={})
    assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY  

def test_register_invalid_email_format(client)-> None:
...
def test_no_token_cannot_list_products()-> None:
    """Access list products route without token → 401"""
    client.cookies.clear()
    response = client.get("/products/products")
    assert response.status_code == 401

def test_list_products_invalid_token()-> None:
...
def test_get_product_by_id_no_token()-> None:
...
def test_get_product_by_id_invalid_token()-> None:
    """Access GET product by ID with invalid token → 401"""
    set_invalid_token()

    response = client.get("/products/products/p123")

    assert response.status_code == 401
    assert response.json()["detail"] == "Invalid or expired access token"


def test_no_token_cannot_create_product()-> None:
    """Access create product route without token → 401"""
    client.cookies.clear()
    response = client.post("/products/products", json={})
    assert response.status_code == 401

def test_create_product_invalid_token()-> None:
...
def test_no_token_cannot_update_product()-> None:
    """Access update product route without token → 401"""
    client.cookies.clear()
    response = client.put("/products/products/x", json={"price": 10})
    assert response.status_code == 401

def test_update_product_invalid_token()-> None:
    """Access update product route with invalid token → 401"""
    set_invalid_token()

    response = client.put("/products/products/p123", json={
        "price": 99
    })
